...
import { AppHeaderComponentAdmin } from './header/header.component';
import { AppSidebarComponentAdmin } from './sidebar/sidebar.component';
...
export class FullComponentAdmin implements OnDestroy, AfterViewInit {
